...
int main(int argc, const char** argv) {
    ...
    stabilizer = new VideoStabilization(5, 1.3, 200, 0.1);
    
    cv::VideoCapture video_cap("filesrc location=/home/kikai/Desktop/long/ostrich.mp4 ! decodebin ! autovideoconvert ! appsink",cv::CAP_GSTREAMER);
    ...
    Mat canvas = Mat::zeros(first_frame.rows, first_frame.cols*2+10, first_frame.type());
        ...
        imshow("original frame and processed frame", canvas);
        cv::waitKey(1);
